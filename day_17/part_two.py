            ...
            if not curr_node.visited:
                ...
                for direction, (drow, dcol) in directions.items():
                    ...
                    if direction == curr_node.direction:
                        dc += 1
                    elif curr_node.direction == "initial":
                        dc = 0
                    elif direction != curr_node.direction and dc < 3:
                        continue
                    else:
                        dc = 0
                    ...
                    if nrow < len(lines) and nrow >= 0 and ncol < len(lines[0]) and ncol >= 0 and not (nrow == curr_node.prev.row and ncol == curr_node.prev.col) and dc < 10:
